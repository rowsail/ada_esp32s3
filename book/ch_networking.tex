...
Where a cellular modem has several graduated sleep modes, the W5500 has exactly one
lever, and it is a blunt one: power the Ethernet PHY down.
That is not a small thing to switch off --- the 100BASE-TX line driver is the bulk
...
again. If you need to stay reachable \emph{while} saving power, that is a job for the
cellular link's eDRX, not for the wired PHY, which is all-or-nothing.

...
TLS~1.3 session to \texttt{dns.google} and authenticates its leaf under a pinned
P-256 intermediate before a query byte is sent; the plain pair is two calls.

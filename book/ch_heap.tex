...
\section{Why a heap, and what lands here}
...
\section{Why first-fit had to go}
...
\section{TLSF, taught from the code}
...
\subsection{Boundary tags: every block knows its neighbours}
...
\subsection{Two-level segregated free lists}
...
\subsection{Allocate, free, split, coalesce}
...
\section{The target glue: \texttt{bare\_heap}}
...
\subsection{Freeing a task's own stack}

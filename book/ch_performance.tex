...
nothing \textemdash{} the accounting simply does not exist.  An engine-monitor
application built on this SDK turns this into a run-statistics harness in its
debug build: every five seconds, one line per registered task

...
To move the \emph{whole} console onto a UART, so every byte goes there (including
\texttt{ESP32S3.Log} and the runtime's own \texttt{Ada.Text\_IO}), use the device
mux instead (Section~\ref{driver:console-mux}):

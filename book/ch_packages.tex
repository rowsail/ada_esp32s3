...
A second benefit follows from the same rule. Because a client depends only on a spec,
a bare-metal application's dependency closure stays small and auditable: you can list
exactly what gets linked. That feeds straight into the static-footprint accounting of

...
The chapter closes with the smallest storage of all, a serial EEPROM, and with a
generic that drives a whole family of them.
...
--  and the slave address for cell A is simply:
function Slave_Of (Dev : Device; A : Memory_Address) return Slave_Address

...
\lstcap{Example 1: bring up a card and read sector 0.}
\begin{lstlisting}
...
\lstcap{Example 2: a non-destructive read / write-back / re-read round-trip.}
\begin{lstlisting}
with ESP32S3.SD_SPI; use ESP32S3.SD_SPI;
with ESP32S3.SPI;
...
\lstcap{Example: 4-bit bus, read a sector.}
\begin{lstlisting}

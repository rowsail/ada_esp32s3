...
128\,KiB; the language interpreters built on this SDK go bigger still).
...
application and every task stack comes from wherever you say. An
engine-monitor application built on this SDK uses exactly this split
...
block cache and the language interpreters' heaps live there).

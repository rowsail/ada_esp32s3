...
\lstcap{Example 2: a button drives an LED.}
\begin{lstlisting}
with ESP32S3.GPIO; use ESP32S3.GPIO;
procedure Button is
...
\lstcap{Example 1: a random word.}
\begin{lstlisting}
...
\lstcap{Example 2: a random nonce.}
\begin{lstlisting}
with ESP32S3.RNG;
...
\lstcap{Example 2: higher resolution and a different span.}
\begin{lstlisting}
with Ada.Text_IO;        use Ada.Text_IO;
with ESP32S3.Temperature; use ESP32S3.Temperature;
...
\lstcap{Example 1: write a command to a device.}
\begin{lstlisting}
with Interfaces;
...
\lstcap{Example 2: wiring-free self-test via internal loopback.}
\begin{lstlisting}
with Interfaces;
with ESP32S3.SPI; use ESP32S3.SPI;
...
\lstcap{Example 1: write a register on a sensor at address \texttt{16\#68\#}.}
\begin{lstlisting}
...
\lstcap{Example 2: register read (write the address, then read).}
\begin{lstlisting}
with ESP32S3.I2C; use ESP32S3.I2C;
...
\lstcap{Example 1: transmit a line.}
\begin{lstlisting}
...
\lstcap{Example 2: echo received bytes (wiring-free, internal loopback).}
\begin{lstlisting}
with ESP32S3.UART; use ESP32S3.UART;

...
\item[Part III, Talking to Hardware] the encapsulation patterns the drivers share,
  ...
  to sleep.
\item[Part IV, Building Real Systems] the storage, networking, Modbus, TLS, and
  even a LISP interpreter built on top, closing with a capstone that wires several
  subsystems into one product.

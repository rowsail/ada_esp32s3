...
package Cert_Verify is
   ...
   function RSA_PKCS1_SHA256 (TBS, Signature, Modulus, Exponent : X509.Byte_Array) return Boolean;
   function RSA_PKCS1_SHA384 (TBS, Signature, Modulus, Exponent : X509.Byte_Array) return Boolean;
   function RSA_PKCS1_SHA512 (TBS, Signature, Modulus, Exponent : X509.Byte_Array) return Boolean;
   ...
   function Ed25519_Verify (Message, Signature, Pub_Key : X509.Byte_Array) return Boolean;

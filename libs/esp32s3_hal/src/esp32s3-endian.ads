...
package ESP32S3.Endian with Pure is
   ...
   function  Join_LE  (B0, B1, B2, B3 : U8) return U32 with Inline;
   procedure Split_LE (W : U32; B0, B1, B2, B3 : out U8) with Inline;

   --  Big-endian (network byte order): byte 0 is the most-significant.
   function  Join_BE16  (Hi, Lo : U8) return U16 with Inline;
   function  Join_BE32  (B0, B1, B2, B3 : U8) return U32 with Inline;
   procedure Split_BE16 (V : U16; Hi, Lo : out U8) with Inline;
   procedure Split_BE32 (V : U32; B0, B1, B2, B3 : out U8) with Inline;

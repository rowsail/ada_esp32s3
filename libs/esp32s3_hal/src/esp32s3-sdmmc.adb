...
package body ESP32S3.SDMMC is
   ...
   type RINTSTS_Bits is record
      Resp_Err, Cmd_Done, Data_Over, RCRC, DCRC, RTO, DRTO, HTO, FRUN, EBE : Boolean;
   end record;
   ...
   begin
      ...
      declare
         Cap : constant Positive := (if C.HS_Active then 50_000_000 else 25_000_000);
      begin
   ...
   procedure Read_Block
     (C : in out Card; LBA : Block_Address; Data : out Block; Result : out Status) is
   begin

...
package body ESP32S3.UART.Text is
   ...
   begin
      return (Write => Write_Adapter'Access, Flush => Flush_Adapter'Access, Ctx => S'Address);
   end As_Device;
   ...
   function As_Input_Device (S : aliased in out Session) return ESP32S3.Serial.In_Device is
   begin

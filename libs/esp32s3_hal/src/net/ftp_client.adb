...
package body FTP_Client is
   ...
   procedure Send_Line (S : Session; Text : String; OK : out Boolean) is
   ...
   begin
      ...
      Finish
        (S,
         (if St /= OK
          then St
          elsif Code in 200 .. 299
          then OK
          elsif Code in 400 .. 599
          then Server_Error
          else Protocol_Error),
         Result);
   end Stream_In;

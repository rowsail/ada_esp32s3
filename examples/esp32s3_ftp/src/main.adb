...
begin
   ...
   if Result /= FTP_Client.OK then
      ...
      FTP_Client.Retrieve
        (Session, Get_Path, FTP_Print.Put_Chunk'Access, System.Null_Address, Result);
      New_Line;
      Put ("[ftp] retrieve result: ");
      Put_Line (Result'Image);

      Put_Line ("[ftp] --- NLST ---");
      FTP_Client.List (Session, FTP_Print.Put_Chunk'Access, System.Null_Address, Result);
      Put ("[ftp] list result: ");
      Put_Line (Result'Image);
      ...
      FTP_Client.Store
        (Session, Put_Path, FTP_Print.Test_Source'Access, System.Null_Address, Result);
